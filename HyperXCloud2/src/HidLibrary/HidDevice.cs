...
namespace HidLibrary
{
    public class HidDevice : IHidDevice
    {
        ...
        // TODO:: MODIFIED BY MYSELF, WAIT FOR UPDATE BY MORE SKILLFULL PROGRAMMERS
        public HidReport ReadReport(int timeout)
        {
            var h = new HidReport(Capabilities.InputReportByteLength, Read(timeout));
            return h;
        }
        ...
        // TODO:: MODIFIED BY MYSELF, WAIT FOR UPDATE BY MORE SKILLFULL PROGRAMMERS
        public async Task<HidReport> ReadReportAsync(int timeout)
        {
